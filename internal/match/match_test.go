...
func TestMatchTitleFallbackYearDisambiguatesAmbiguousTitles(t *testing.T) {
	...
	res := New(fake, nil).Match(t.Context(), []seadex.Entry{{AniListID: 500}}, snap, idx, Memo{})
...
func TestMatchTitleFallbackSucceedsWithoutRecord(t *testing.T) {
	...
	res := New(fake, nil).Match(t.Context(), []seadex.Entry{{AniListID: 600}}, snap, idx, Memo{})
...
func TestMatchEmptyFormatTitleFallbackSearchesBothArrs(t *testing.T) {
	...
	res := New(fake, nil).Match(t.Context(), []seadex.Entry{{AniListID: 610}}, snap, idx, Memo{})
...
func TestMatchMemoizedSteadyStateSurvivesOutage(t *testing.T) {
	...
	res := New(degradedAniList{}, nil).Match(t.Context(), []seadex.Entry{{AniListID: 11}}, snap, idx, memo)
...
func TestMatchTitleFallbackKeepsUnknownYearItem(t *testing.T) {
	...
	res := New(fake, nil).Match(t.Context(), []seadex.Entry{{AniListID: 620}}, snap, idx, Memo{})
...
func TestMatchIDLessUntypedRecordRoutesByAniListFormat(t *testing.T) {
	...
	res := New(fake, nil).Match(t.Context(), []seadex.Entry{{AniListID: 21403}}, snap, idx, Memo{})
